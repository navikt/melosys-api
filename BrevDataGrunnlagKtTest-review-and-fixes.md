...
**Status**: ✅ Completed
**Verdict**: Changed
**Comments**: Migrated FagsakTestFactory and BehandlingTestFactory to use Kotlin DSL forTest functions.
...
**Status**: ✅ Completed
**Verdict**: Unchanged
**Comments**: Test names already use backtick syntax.
...
**Status**: ✅ Completed
**Verdict**: Changed
**Comments**: Grouped related assertions using run in first test.
