...
public class SedUtilsTest {
    ...
    public void hentSedTypeFraLovvalgsBestemmelse_forventA009() {
        SedType sedType =SedUtils.hentSedTypeFraLovvalgsBestemmelse(LovvalgBestemmelse_883_2004.FO_883_2004_ART12_1);
        assertThat(sedType, is(SedType.A009));
    }

    @Test
    public void hentBucFraLovvalgsBestemmelse_forventLABUC04() {
        BucType bucType = SedUtils.hentBucFraLovvalgsBestemmelse(LovvalgBestemmelse_883_2004.FO_883_2004_ART12_1);
