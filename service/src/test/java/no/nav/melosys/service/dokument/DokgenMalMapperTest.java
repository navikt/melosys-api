...
class DokgenMalMapperTest {
    ...
    @BeforeEach
    void init() {
        dokgenMalMapper = new DokgenMalMapper(mockKodeverkService, mockBehandlingsresultatService, mockEregFasade, mockPersondataFasade, medlemAvFolketrygdenService);
    }
