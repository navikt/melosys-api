...
public class PdlObjectFactory {
    ...
    public static Person lagPerson() {
        return new Person(
            ...
            Set.of(new no.nav.melosys.integrasjon.pdl.dto.person.Foedested("NOR", "fødested", metadata())),
            Set.of(new no.nav.melosys.integrasjon.pdl.dto.person.Foedselsdato(LocalDate.EPOCH, 1970, metadata())),
