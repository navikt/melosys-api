...
object PdlObjectFactory {
    ...
    fun folkeregistermetadata(): Folkeregistermetadata = FOLKEREGISTERMETADATA
    ...
    fun lagNorskBostedsadresse(gatenavn: String = "Kirkegata", registrertDato: LocalDateTime? = null): Bostedsadresse = if (registrertDato == null) {
        Bostedsadresse(
            LocalDateTime.parse("2020-01-01T00:00:00"),
            LocalDateTime.parse("2020-05-05T00:00:00"),
            "Kari Hansen",
