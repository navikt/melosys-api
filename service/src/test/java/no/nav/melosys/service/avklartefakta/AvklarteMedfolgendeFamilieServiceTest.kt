...
class AvklarteMedfolgendeFamilieServiceTest {
    ...
    fun `lagreMedfolgendeFamilieSomAvklartefakta ikke omfattet familie lagres korrekt`() {
        ...
        avklartBarn.run {
            subjekt shouldBe UUID_BARN
            type shouldBe Avklartefaktatyper.VURDERING_LOVVALG_BARN
        ...
        avklartEktefelleSamboer.run {
            subjekt shouldBe UUID_EKTEFELLE_SAMBOER
            type shouldBe Avklartefaktatyper.VURDERING_MEDLEMSKAP_EKTEFELLE_SAMBOER
    ...
    fun `hentAvklarteMedfølgendeBarn returnerer medfølgende barn`() {
        ...
        avklarteMedfolgendeBarn.run {
            familieIkkeOmfattetAvNorskTrygd
                .shouldHaveSize(1)
                .single().uuid shouldBe UUID_BARN2

            familieOmfattetAvNorskTrygd
                .shouldHaveSize(1)
                .single().uuid shouldBe UUID_BARN
        }
    }
