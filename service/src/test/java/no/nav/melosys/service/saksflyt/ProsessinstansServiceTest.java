...
class ProsessinstansServiceTest {
    ...
    void opprettProsessinstansOpprettOgDistribuerBrevBruker() {
        ...
        MangelbrevBrevbestilling lagretBrevbestilling = (MangelbrevBrevbestilling) lagretInstans.getDataWithDefaultTyping(ProsessDataKey.BREVBESTILLING, DokgenBrevbestilling.class);
    ...
    @Test
    void opprettProsessinstansJournalføring_utendlandskMyndighet_settesIProsessinstans() throws IkkeFunnetException {
