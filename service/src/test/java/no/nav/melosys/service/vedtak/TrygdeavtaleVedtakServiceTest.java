...
class TrygdeavtaleVedtakServiceTest {
    ...
    @BeforeEach
    void setup() {
        trygdeavtaleVedtakService = new TrygdeavtaleVedtakService(behandlingsresultatService, behandlingService, prosessinstansService, oppgaveService, dokgenService, medRegisterOpplysningService);
    ...
    void fattVedtak_førstegangsvedtak_fatterVedtak() throws ValideringException {
        ...
        verify(medRegisterOpplysningService).kontrollerVedtak(any(Behandling.class), any(Behandlingsresultat.class), eq(Sakstyper.TRYGDEAVTALE), any(Behandlingsresultattyper.class));
