...
internal class ÅrsavregningServiceTest {
    ...
    fun `opprettNyÅrsavregning kaster exception når flere Aarsavregninger eksisterer for samme år på samme Fagsak`() {
        ...
        every { aarsavregningRepository.eksisterendeÅrsavregningFinnesPåÅr(1, 2023) }.returns(1)
        every { aarsavregningRepository.eksisterendeÅrsavregningFinnesPåÅr(2, 2023) }.returns(1)
