...
class UtpekingAnnetLandMapperTest {
    private val utpekingAnnetLandMapper = UtpekingAnnetLandMapper()
    ...
    fun mapTilBrevXML() {
        ...
        val brevXML = utpekingAnnetLandMapper.mapTilBrevXML(
            fellesType, navFelles, behandling, Behandlingsresultat.forTest { }, brevDataUtpekingAnnetLand
        )
