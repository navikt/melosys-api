...
class DokgenMalMapper(
    ...
    private fun lagDokgenDtoFraBestilling(brevbestilling: DokgenBrevbestilling): DokgenDto {
        return when (brevbestilling.produserbartdokument) {
            ...
            Produserbaredokumenter.IKKE_YRKESAKTIV_FRIVILLIG_FTRL -> innvilgelseFtrlMapper.mapIkkeYrkesaktivFrivillig(brevbestilling as IkkeYrkesaktivFrivilligFtrlBrevbestilling)
            ...
            Produserbaredokumenter.IKKE_YRKESAKTIV_PLIKTIG_FTRL -> innvilgelseFtrlMapper.mapIkkeYrkesaktivPliktig(brevbestilling as IkkeYrkesaktivPliktigFtrlBrevbestilling)
