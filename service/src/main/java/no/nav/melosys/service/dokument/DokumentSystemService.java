...
public class DokumentSystemService extends DokumentService {
    ...
    public DokumentSystemService(BehandlingRepository behandlingRepository,
                                 ...
                                 BrevmottakerService brevmottakerService, BrevDataByggerVelger brevDataByggerVelger, BrevdataInput brevdataInput) {
        super(behandlingRepository, brevDataService, dokSysFasade, null,  brevmottakerService, brevDataByggerVelger, brevdataInput);
    }
}