...
public class LovligeBehandlingsKombinasjoner {
    // EU_EØS
    private static final Set<Behandlingstema> EU_EOS_LOVVALG_MEDLEMSKAP_BEHANDLINGSTEMA_1 = Set.of(UTSENDT_ARBEIDSTAKER, UTSENDT_SELVSTENDIG, ARBEID_TJENESTEPERSON_ELLER_FLY, ARBEID_FLERE_LAND, ARBEID_KUN_NORGE, IKKE_YRKESAKTIV, PENSJONIST);
    private static final Set<Behandlingstema> EU_EOS_LOVVALG_MEDLEMSKAP_BEHANDLINGSTEMA_2 = Set.of(FORESPØRSEL_TRYGDEMYNDIGHET, TRYGDETID);
    ...
    private static final Set<Behandlingstyper> EU_EOS_LOVVALG_MEDLEMSKAP_BEHANDLINGSTYPE_1 = Set.of(FØRSTEGANG, NY_VURDERING, KLAGE, HENVENDELSE);
    private static final Set<Behandlingstyper> EU_EOS_LOVVALG_MEDLEMSKAP_BEHANDLINGSTYPE_2 = Set.of(HENVENDELSE);
    ...
    public static final BehandlingsKombinasjon EU_EOS_LOVVALG_MEDLEMSKAP_BEHANDLINGS_KOMBINASJON_1 = new BehandlingsKombinasjon(EU_EOS_LOVVALG_MEDLEMSKAP_BEHANDLINGSTEMA_1, EU_EOS_LOVVALG_MEDLEMSKAP_BEHANDLINGSTYPE_1);
    public static final BehandlingsKombinasjon EU_EOS_LOVVALG_MEDLEMSKAP_BEHANDLINGS_KOMBINASJON_2 = new BehandlingsKombinasjon(EU_EOS_LOVVALG_MEDLEMSKAP_BEHANDLINGSTEMA_2, EU_EOS_LOVVALG_MEDLEMSKAP_BEHANDLINGSTYPE_2);
