...
public class UtledMedlemskapsperiodeNyVurderingDto extends UtledMedlemskapsperioderDto {
    ...
    private final SøknadNorgeEllerUtenforEØS opprinneligSøknad;
    ...
    public UtledMedlemskapsperiodeNyVurderingDto(ErPeriode søknadsperiode,
                                                 ...
                                                 SøknadNorgeEllerUtenforEØS opprinneligSøknad) {
    ...
    public SøknadNorgeEllerUtenforEØS getOpprinneligSøknad() {
