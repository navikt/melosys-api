...
public class LovvalgTilEuxMapper {
    ...
    public static String mapMelosysLovvalgTilEux(LovvalgBestemmelse lovvalgBestemmelse) {
        if (lovvalgBestemmelse instanceof LovvalgBestemmelse_883_2004) {
            return mapLovvalgBestemmelse_883_2004TilEux((LovvalgBestemmelse_883_2004) lovvalgBestemmelse);
        } else if (lovvalgBestemmelse instanceof LovvalgBestemmelse_987_2009) {
            return mapLovvalgBestemmelse_987_2009TilEux((LovvalgBestemmelse_987_2009) lovvalgBestemmelse);
        }
    ...
    private static String mapLovvalgBestemmelse_987_2009TilEux(LovvalgBestemmelse_987_2009 lovvalgBestemmelse) {
    ...
    private static String mapLovvalgBestemmelse_883_2004TilEux(LovvalgBestemmelse_883_2004 lovvalgBestemmelse) {
        switch (lovvalgBestemmelse) {
