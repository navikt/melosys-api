...
public class EessiMottakService {
    ...
    public void behandleMottattMelding(MelosysEessiMelding melosysEessiMelding) {
        ...
        prosessinstans.setData(ProsessDataKey.BEHANDLINGSTYPE, Behandlingstyper.UNNTAK_FRA_MEDLEMSKAP);
        ...
        prosessinstans.setData(ProsessDataKey.OPPHOLDSLAND, "NO"); //todo
        prosessinstans.setData(ProsessDataKey.SØKNADSPERIODE, tilPeriode(melosysEessiMelding.getPeriode()));
        prosessinstans.setData(ProsessDataKey.SEDDOKUMENT, opprettSedDokument(melosysEessiMelding));
    ...
    private SedDokument opprettSedDokument(MelosysEessiMelding melosysEessiMelding) {
        ...
        sedDokument.setLovvalgBestemmelse(
            LovvalgTilBestemmelseDtoMapper.mapBestemmelseDtoTilMelosysLovvalgBestemmelse(melosysEessiMelding.getArtikkel())
        );
        ...
        utenlandskIdent.ident = melosysEessiMelding.getUtenlandskIdent().getIdent();
        utenlandskIdent.landKode = melosysEessiMelding.getUtenlandskIdent().getLandkode();
        sedDokument.setUtenlandskIdent(utenlandskIdent);
