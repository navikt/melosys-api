...
public class FagsakService {
    ...
    public void oppdaterSakstema(String saksnummer, Sakstemaer sakstema) {
        Fagsak fagsak = hentFagsak(saksnummer);
        validerSakstemaOppdatering(fagsak, sakstema);
