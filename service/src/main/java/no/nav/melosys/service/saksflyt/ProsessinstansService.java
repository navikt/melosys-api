...
public class ProsessinstansService {
    ...
    public void opprettProsessinstansIverksettVedtakEos(Behandling behandling, Behandlingsresultattyper behandlingsresultatType,
        ...
        if (StringUtils.isNotEmpty(nyVurderingBakgrunn)) {
            prosessinstans.setData(ProsessDataKey.NY_VURDERING_BAKGRUNN, nyVurderingBakgrunn);
        }

        lagre(prosessinstans);
    }

    public void opprettProsessinstansIverksettVedtakFTRL(Behandling behandling, FattFtrlVedtakRequest request) {
        Prosessinstans prosessinstans = new ProsessinstansBuilder()
    ...
    public void opprettProsessinstansIverksettVedtakTrygdeavtale(Behandling behandling, FattTrygdeavtaleVedtakRequest request) {
        Prosessinstans prosessinstans = new ProsessinstansBuilder()
