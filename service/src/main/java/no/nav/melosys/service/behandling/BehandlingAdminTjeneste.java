...
public class BehandlingAdminTjeneste implements AdminTjeneste {
    private final String apiKey;
    private final BehandlingService behandlingService;
    private static final Logger log = LoggerFactory.getLogger(BehandlingAdminTjeneste.class);


    public BehandlingAdminTjeneste(@Value("${Melosys-admin.apikey}") String apiKey, BehandlingService behandlingService) {
        this.apiKey = apiKey;
