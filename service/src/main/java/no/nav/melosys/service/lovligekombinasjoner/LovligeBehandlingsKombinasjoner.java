...
public class LovligeBehandlingsKombinasjoner {
    ...
    private static final Set<Behandlingstema> EU_EOS_TRYGDEAVGIFT_BEHANDLINGSTEMA = new LinkedHashSet<>(List.of(YRKESAKTIV));
    private static final Set<Behandlingstema> EU_EOS_TRYGDEAVGIFT_BEHANDLINGSTEMA_PENSJONIST = new LinkedHashSet<>(List.of(PENSJONIST));
    ...
    private static final Set<Behandlingstyper> EU_EOS_TRYGDEAVGIFT_PENSJONIST_BEHANDLINGSTYPE = new LinkedHashSet<>(List.of(FØRSTEGANG, NY_VURDERING, KLAGE, HENVENDELSE, ÅRSAVREGNING));
    ...
    public static final BehandlingstemaBehandlingstyperKombinasjon EU_EOS_TRYGDEAVGIFT_PENSJONIST_BEHANDLINGS_KOMBINASJON = new BehandlingstemaBehandlingstyperKombinasjon(EU_EOS_TRYGDEAVGIFT_BEHANDLINGSTEMA_PENSJONIST, EU_EOS_TRYGDEAVGIFT_PENSJONIST_BEHANDLINGSTYPE);
    ...
    private static final Set<Behandlingstema> FTRL_ÅRSAVREGNING_BEHANDLINGSTEMA = new LinkedHashSet<>(List.of(YRKESAKTIV, PENSJONIST));
