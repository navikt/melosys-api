...
public class LovligeBehandlingsKombinasjoner {
    ...
    public static final BehandlingstemaBehandlingstyperKombinasjon EU_EOS_UNNTAK_BEHANDLINGS_KOMBINASJON_A1_PAPIR = new BehandlingstemaBehandlingstyperKombinasjon(Set.of(A1_ANMODNING_OM_UNNTAK_PAPIR), Set.of(FØRSTEGANG, NY_VURDERING, KLAGE));
