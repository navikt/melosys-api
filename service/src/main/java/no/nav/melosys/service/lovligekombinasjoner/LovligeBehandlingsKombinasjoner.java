...
public class LovligeBehandlingsKombinasjoner {
    ...
    private static final Set<Behandlingstema> EU_EOS_ÅRSAVREGNING_BEHANDLINGSTEMA = new LinkedHashSet<>(List.of(UTSENDT_ARBEIDSTAKER, UTSENDT_SELVSTENDIG, ARBEID_TJENESTEPERSON_ELLER_FLY, ARBEID_FLERE_LAND, ARBEID_KUN_NORGE));
    ...
    private static final Set<Behandlingstyper> EU_EOS_ÅRSAVREGNING_BEHANDLINGSTYPE = new LinkedHashSet<>(List.of(ÅRSAVREGNING));
    ...
    public static final BehandlingstemaBehandlingstyperKombinasjon EU_EOS_ÅRSAVREGNING_BEHANDLINGS_KOMBINASJON = new BehandlingstemaBehandlingstyperKombinasjon(EU_EOS_ÅRSAVREGNING_BEHANDLINGSTEMA, EU_EOS_ÅRSAVREGNING_BEHANDLINGSTYPE);
    ...
    private static final Set<Behandlingstema> TRYGDEAVTALE_ÅRSAVREGNING_BEHANDLINGSTEMA = new LinkedHashSet<>(List.of(YRKESAKTIV));
    ...
    private static final Set<Behandlingstyper> TRYGDEAVTALE_ÅRSAVREGNING_BEHANDLINGSTYPE = new LinkedHashSet<>(List.of(ÅRSAVREGNING));
