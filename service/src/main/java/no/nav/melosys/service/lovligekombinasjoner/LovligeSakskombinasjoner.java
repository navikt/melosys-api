...
public class LovligeSakskombinasjoner {
    ...
    private static final SakstemaBehandlingsKombinasjon EU_EOS_TRYGDEAVGIFT_SAK = new SakstemaBehandlingsKombinasjon(TRYGDEAVGIFT, Set.of(EU_EOS_TRYGDEAVGIFT_BEHANDLINGS_KOMBINASJON,EU_EOS_ÅRSAVREGNING_BEHANDLINGS_KOMBINASJON));
    private static final SakstemaBehandlingsKombinasjon FOLKETRYGDLOVEL_LOVVALG_MEDLEMSKAP_SAK = new SakstemaBehandlingsKombinasjon(MEDLEMSKAP_LOVVALG, new LinkedHashSet<>(List.of(FTRL_LOVVALG_MEDLEMSKAP_BEHANDLINGS_KOMBINASJON)));
    private static final SakstemaBehandlingsKombinasjon FOLKETRYGDLOVEL_TRYGDEAVGIFT_SAK = new SakstemaBehandlingsKombinasjon(TRYGDEAVGIFT, new LinkedHashSet<>(List.of(FTRL_TRYGDEAVGIFT_BEHANDLINGS_KOMBINASJON, FTRL_ÅRSAVREGNING_BEHANDLINGS_KOMBINASJON)));
    ...
    private static final SakstemaBehandlingsKombinasjon TRYGDEAVTALE_TRYGDEAVGIFT_SAK = new SakstemaBehandlingsKombinasjon(TRYGDEAVGIFT, Set.of(TRYGDEAVTALE_TRYGDEAVGIFT_BEHANDLINGS_KOMBINASJON, TRYGDEAVTALE_ÅRSAVREGNING_BEHANDLINGS_KOMBINASJON));
