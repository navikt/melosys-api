...
**Status**: ✅ Completed
**Verdict**: Changed
**Comments**: Converted BehandlingTestFactory and FagsakTestFactory to use Kotlin DSL with forTest functions.
...
**Status**: ✅ Completed
**Verdict**: Unchanged
**Comments**: Test names already using backticks with readable Norwegian sentences.
...
**Status**: ✅ Completed
**Verdict**: Unchanged
**Comments**: Single assertions kept as-is, no multiple assertions on same object found.
