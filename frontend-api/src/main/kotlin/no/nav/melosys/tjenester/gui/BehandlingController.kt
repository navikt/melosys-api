...
class BehandlingController(
    ...
    private fun tilBehandlingDto(behandling: Behandling, saksbehandler: String): BehandlingDto {
        val oppgave = if (unleash.isEnabled(ToggleName.MELOSYS_TILDEL_OPPGAVE)) finnOppgave(behandling.id) else null
    ...
    private fun finnOppgave(behandlingID: Long): Oppgave? = try {
        oppgaveService.finnBehandlingsoppgaveForBehandlingID(behandlingID)
