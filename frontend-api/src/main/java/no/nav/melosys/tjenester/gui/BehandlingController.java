...
public class BehandlingController {
    ...
    private static final Logger log = LoggerFactory.getLogger(BehandlingController.class);
    ...
    private BehandlingOppsummeringDto tilOppsummeringDto(Behandling behandling) {
        ...
        behandlingOppsummeringDto.setSisteOpplysningerHentetDato(
            behandling.erEøsPensjonist() && behandling.getSaksopplysninger().isEmpty()
                ? null
                : behandling.getSisteOpplysningerHentetDato()
        );
