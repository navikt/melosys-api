...
public class TrygdeavtaleController {
    ...
    private static final Logger log = LoggerFactory.getLogger(TrygdeavtaleController.class);
    ...
    public TrygdeavtaleController(TrygdeavtaleService trygdeavtaleService,
