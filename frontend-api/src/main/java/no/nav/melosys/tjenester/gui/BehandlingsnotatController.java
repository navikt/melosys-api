...
public class BehandlingsnotatController {
    ...
    private static final Logger log = LoggerFactory.getLogger(BehandlingsnotatController.class);
    ...
    public BehandlingsnotatController(BehandlingsnotatService behandlingsnotatService,
