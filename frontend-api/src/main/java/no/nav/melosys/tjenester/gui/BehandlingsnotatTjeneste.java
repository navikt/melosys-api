...
public class BehandlingsnotatTjeneste {
    ...
    public ResponseEntity hentNotaterForFagsak(@PathVariable("saksnummer") String saksnummer) throws IkkeFunnetException {
    ...
    @ApiOperation(value = "Oppretter et nytt notat på fagsaken sin aktive behandling",
        response = BehandlingnotatGetDto.class)
    public ResponseEntity opprettNotatForFagsak(@PathVariable("saksnummer") String saksnummer, @RequestBody BehandlingsnotatPostDto behandlingsnotatPostDto) throws FunksjonellException, TekniskException {
    ...
    @ApiOperation(value = "Oppdaterer tekst på et notat",
        response = BehandlingnotatGetDto.class)
    public ResponseEntity oppdaterNotat(@PathVariable("notatID") Long notatID, @RequestBody BehandlingsnotatPostDto behandlingsnotatPostDto) throws FunksjonellException {
        return ResponseEntity.ok(
