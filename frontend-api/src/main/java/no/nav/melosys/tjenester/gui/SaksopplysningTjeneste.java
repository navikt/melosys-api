...
public class SaksopplysningTjeneste {
    ...
    public ResponseEntity<Void> oppfriskSaksopplysning(@PathVariable("behandlingID") long behandlingID, @RequestParam(required = false) boolean medFamilierelasjoner, @RequestParam(required = false) boolean inkluderSiste5Aar) {
        aksesskontroll.autoriserSkriv(behandlingID);
        oppfriskSaksopplysningerService.oppfriskSaksopplysning(behandlingID, medFamilierelasjoner, inkluderSiste5Aar);
