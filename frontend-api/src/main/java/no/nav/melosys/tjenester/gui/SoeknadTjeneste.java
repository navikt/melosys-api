...
public class SoeknadTjeneste {
    ...
    public ResponseEntity hentSøknad(@PathVariable("behandlingID") long behandlingID) throws TekniskException, IkkeFunnetException, SikkerhetsbegrensningException {
    ...
    @ApiOperation(
        ...
        response = SoeknadDto.class)
    public SoeknadDto registrerSøknad(@RequestBody SoeknadDto soeknadInnDto) throws FunksjonellException, TekniskException {
