...
class ValideringUnntaksperiodeControllerTest {
    ...
    void validerUnntak_ok() throws Exception {
        ValideringUnntaksperiodeController.UnntaksperiodeRequestDto requestDto = new ValideringUnntaksperiodeController.UnntaksperiodeRequestDto(LocalDate.parse("2020-01-01"), LocalDate.parse("2021-05-15"));
