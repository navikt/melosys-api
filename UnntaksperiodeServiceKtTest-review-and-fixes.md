...
**Status**: ✅ Completed
**Verdict**: Unchanged
**Comments**: Code already correctly uses apply for object initialization throughout.

#### Rule 2.2: Migrate from Java Builders to Kotlin DSL
**Status**: ✅ Completed
**Verdict**: Changed
**Comments**: Fixed 1 occurrence of BehandlingTestFactory.builderWithDefaults() converted to Behandling.forTest {} DSL pattern. Added import for forTest DSL.
...
- [✅] All tests pass (10 tests, 0 failures, 0 errors)
