...
// Saksopplysning with document types
val behandling = Behandling.forTest {
    fagsak { medBruker() }
    saksopplysning {
...
| `Saksopplysning` | `SaksopplysningTestFactory` |
| `ArbeidsforholdDokument` | `ArbeidsforholdDokumentBuilder` |
| `Soeknad` | `SoeknadTestFactory` |
