...
import no.nav.melosys.itest.mock.SoapConfig
...
/**
 * Container-based version of YrkesaktivEosVedtakIT.
...
class ContainerYrkesaktivEosVedtakIT(
    ...
    fun setup() {
        ...
        // Note: No MedlRepo.repo.clear() needed - container handles clearing via HTTP
    }
