...
/**
 * Container-based version of SedMottakTestIT.
 * Uses ContainerMockServerTestBase which uses the mock container via HTTP
 * instead of the in-process mock.
 */
@Import(SoapConfig::class)
class ContainerSedMottakTestIT(
    ...
    @Test
    @Disabled("Requires POST /testdata/buc endpoint in melosys-docker-compose-mock - see ADD_MISSING_ENDPOINTS.md")
