...
/**
 * Base class for container-based integration tests that need journalføring functionality.
 *
 * This is the container-based equivalent of JournalfoeringBase.
 * Uses mockVerificationClient.opprettJfrOppgave() instead of JournalføringsoppgaveGenerator.
 */
open class ContainerJournalfoeringBase(
    extensionForWireMock: Extension? = null
) : ContainerMockServerTestBase(extensionForWireMock) {
