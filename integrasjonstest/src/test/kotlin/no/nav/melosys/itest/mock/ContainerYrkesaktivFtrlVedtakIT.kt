...
/**
 * Container-based version of YrkesaktivFtrlVedtakIT.
 * Uses melosys-mock container for journalføring operations.
 */
class ContainerYrkesaktivFtrlVedtakIT : ContainerAvgiftFaktureringTestBase(TrygdeavgiftsberegningTransformer()) {
