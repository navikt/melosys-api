 ...
 *
 * This is the container-based equivalent of MockServerTestBaseWithProsessManager.
 */
open class ContainerMockServerTestBase(
    ...
    @BeforeEach
    fun beforeContainerMockServerTestBase() {
    ...
    @AfterEach
    fun afterContainerMockServerTestBase() {
