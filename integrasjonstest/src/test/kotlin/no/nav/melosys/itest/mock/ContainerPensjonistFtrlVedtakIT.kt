...
/**
 * Container-based version of PensjonistFtrlVedtakIT.
 * Uses melosys-mock container for journalføring operations.
 */
class ContainerPensjonistFtrlVedtakIT : ContainerAvgiftFaktureringTestBase(TrygdeavgiftsberegningTransformer()) {
    ...
    private lateinit var manglendeFakturabetalingMeldingTemplate: KafkaTemplate<String, ManglendeFakturabetalingMelding>
