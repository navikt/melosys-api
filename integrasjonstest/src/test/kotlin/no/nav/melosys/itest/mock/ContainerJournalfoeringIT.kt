...
/**
 * Container-based version of JournalfoeringIT.
...
class ContainerJournalfoeringIT(
    @Autowired private val behandlingRepository: BehandlingRepository,
    @Autowired private val behandlingsresultatRepository: BehandlingsresultatRepository,
    @Autowired private val fagsakRepository: FagsakRepository
) : ContainerJournalfoeringBase() {

    // Note: No @AfterEach needed for journalpostRepo.repo.clear() - container handles this via HTTP
    ...
    fun journalførOgKnyttTilEksisterendeSak() {
        ...
        // Get existing journalpost IDs before the operation
        ...
        // Get newly created journalposter (excluding those that existed before)
        val tilKnyttetJournalpost = mockVerificationClient.journalposter()
            .filterNot { it.journalpostId in eksisterendeJournalpostIds }
