...
class ContainerIkkeYrkesaktivVedtakIT(
    ...
    fun setup() {
        ...
        // Note: No MedlRepo.repo.clear() needed - container base handles clearing via HTTP
    }
        ...
        val mottatteOpplysninger =
            mottatteOpplysningerService.hentEllerOpprettMottatteOpplysninger(behandling.id, false)
                ...
                .mottatteOpplysningerData.apply {
                    ...
                    (this as SøknadIkkeYrkesaktiv).ikkeYrkesaktivSituasjontype = Ikkeyrkesaktivsituasjontype.STUDENT
                }
