...
/**
 * Container-based version of AvsluttBehandlingArt13JobbIT.
 * Uses melosys-mock container for external service mocking.
 */
class ContainerAvsluttBehandlingArt13JobbIT(
    ...
    fun setup() {
        ...
        // Set up MEDL test data via container mock HTTP endpoint
