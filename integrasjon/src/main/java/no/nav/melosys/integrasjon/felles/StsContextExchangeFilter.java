...
public class StsContextExchangeFilter extends GenericContextExchangeFilter {

    private final RestStsClient restStsClient;

    public StsContextExchangeFilter(RestStsClient restStsClient, ClientConfigurationProperties clientConfigurationProperties,
