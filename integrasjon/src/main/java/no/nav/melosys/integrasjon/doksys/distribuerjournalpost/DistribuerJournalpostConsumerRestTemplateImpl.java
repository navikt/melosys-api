...
@Retryable
public class DistribuerJournalpostConsumerRestTemplateImpl extends RestErrorHandler implements DistribuerJournalpostConsumer {
    private static final Logger log = LoggerFactory.getLogger(DistribuerJournalpostConsumer.class);

    private final RestTemplate restTemplate;
    public DistribuerJournalpostConsumerRestTemplateImpl(RestTemplate restTemplate) {
