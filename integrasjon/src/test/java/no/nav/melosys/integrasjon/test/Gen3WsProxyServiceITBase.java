...
public abstract class Gen3WsProxyServiceITBase {
    ...
    private static final String USERID_1 = "Z990405";
    ...
    public static void setupOpenAMSecurity() throws Exception {
        ...
        log.info("username " + System.getProperty("systembruker.username"));
        log.info("pass " + System.getProperty("systembruker.password"));
