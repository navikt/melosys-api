...
**Status**: ✅ Completed
**Verdict**: Unchanged
**Comments**: Already using apply correctly in multiple places (BrevDataInnvilgelseFlereLand, BrevDataA1, Behandlingsresultat, Lovvalgsperiode).
...
**Status**: ✅ Completed
**Verdict**: Changed
**Comments**: Added blank lines to separate Arrange, Act, Assert sections in mapTilBrevXml test method.

#### Rule 2.4: Use Expression Body When Possible
**Status**: ✅ Completed
**Verdict**: Changed
**Comments**: Converted several helper functions to expression body syntax (lagLovvalgsperiode, lagBehandlingsresultat, lagFagsak, lagBehandling).
...
**Status**: ✅ Completed
**Verdict**: Unchanged
**Comments**: Already using Kotest matchers (shouldMatch) correctly.
