...
**Status**: ✅ Completed
**Verdict**: Changed
**Comments**: All 6 test methods already use backticks.
...
**Status**: ✅ Completed
**Verdict**: Unchanged
**Comments**: Already correctly using apply for Saksopplysning objects.

#### Rule 2.2: Migrate from Java Builders to Kotlin DSL
**Status**: ✅ Completed
**Verdict**: Changed
**Comments**: Converted BehandlingTestFactory.builderWithDefaults() to Behandling.forTest DSL.
...
**Status**: ✅ Completed
**Verdict**: Changed
**Comments**: Converted 5 helper functions to use expression body syntax.
...
**Status**: ✅ Completed
**Verdict**: Unchanged
**Comments**: No multiple assertions on same object that would benefit from run.
