...
begin
    ...
    then 
        ...
        l_aktoer_dvh.institusjon_id       := :new.institusjon_id;
        ...
        l_aktoer_dvh.representerer        := :new.representerer;
    ...
    then
        ...
        l_aktoer_dvh.institusjon_id       := :old.institusjon_id;
        ...
        l_aktoer_dvh.representerer        := :old.representerer;
