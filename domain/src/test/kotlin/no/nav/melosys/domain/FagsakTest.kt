...
internal class FagsakTest {
    ...
    fun getAktivBehandling() {
        val b1 = Behandling.forTest { status = Behandlingsstatus.AVSLUTTET; type = Behandlingstyper.FØRSTEGANG  }
        val b2 = Behandling.forTest { status = Behandlingsstatus.UNDER_BEHANDLING; type = Behandlingstyper.FØRSTEGANG  }
    ...
    fun hentTidligsteInaktivBehandling_toInaktive() {
        ...
        val aktivBehandling = Behandling.forTest { status = Behandlingsstatus.UNDER_BEHANDLING }
        val seinesteInaktiveBehandling = Behandling.forTest {
            status = Behandlingsstatus.AVSLUTTET
    ...
    fun getSistOppdaterteBehandling_medTreBehandlinger() {
        val sistOppdaterteBehandling = Behandling.forTest {
            endretDato = Instant.parse("2019-01-10T10:37:30.00Z")
            type = Behandlingstyper.FØRSTEGANG
        }
