...
import static no.nav.melosys.domain.avgift.TrygdeavgiftDeprecated.AvgiftForInntekt.NORSK_INNTEKT;
import static no.nav.melosys.domain.avgift.TrygdeavgiftDeprecated.AvgiftForInntekt.UTENLANDSK_INNTEKT;

@Deprecated
@Entity
@Table(name = "trygdeavgift_deprecated")
public class TrygdeavgiftDeprecated {
    ...
    public TrygdeavgiftDeprecated() {
    }

    public TrygdeavgiftDeprecated(Medlemskapsperiode medlemskapsperiode,
