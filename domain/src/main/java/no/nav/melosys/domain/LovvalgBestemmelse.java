...
public enum LovvalgBestemmelse implements InterntKodeverkTabell<LovvalgBestemmelse> {
    ...
    @Converter
    public static class DbKonverterer extends InterntKodeverkTabell.DbKonverterer<LovvalgBestemmelse> {
        @Override
