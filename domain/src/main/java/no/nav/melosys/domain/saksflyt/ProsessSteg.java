...
public enum ProsessSteg implements Kodeverk {
    ...
    OPPRETT_TIDLIGERE_JOURNALPOSTER_FOR_SAK("Opprett_journalposter_retrospektivt", "Oppretter journalposter tilbake i tid dersom de har tidligere har blitt markert som uidentifiserbare"),
