...
import no.nav.melosys.domain.dokument.soap.inntekt.tillegsinfo.Tilleggsinformasjon;
import no.nav.melosys.domain.dokument.soap.inntekt.inntektstype.Loennsinntekt;
import no.nav.melosys.domain.dokument.soap.inntekt.inntektstype.Naeringsinntekt;
import no.nav.melosys.domain.dokument.soap.inntekt.inntektstype.PensjonEllerTrygd;
import no.nav.melosys.domain.dokument.soap.inntekt.inntektstype.YtelseFraOffentlige;
