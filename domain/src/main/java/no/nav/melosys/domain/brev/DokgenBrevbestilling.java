...
@JsonSubTypes(
    {
        ...
        @JsonSubTypes.Type(value = InnvilgelseFtrlBrevbestilling.class),
        ...
        @JsonSubTypes.Type(value = IkkeYrkesaktivFrivilligFtrlBrevbestilling.class),
        @JsonSubTypes.Type(value = IkkeYrkesaktivPliktigFtrlBrevbestilling.class)
    }
)
