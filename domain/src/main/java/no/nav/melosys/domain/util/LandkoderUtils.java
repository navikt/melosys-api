...
public final class LandkoderUtils {
    ...
    public static Collection<Landkoder> iso2KoderTilLandkoder(Collection<String> iso2Koder) {
        return iso2Koder.stream().map(Landkoder::valueOf).collect(Collectors.toSet());
    }
}
