...
public enum Bestemmelse {
    ...
    private static final Map<LovvalgBestemmelse, Bestemmelse> GB_KONV_BESTEMMELSE_MAP =
        Maps.newHashMap(ImmutableMap.<LovvalgBestemmelse, Bestemmelse>builder()
            ...
            .put(Lovvalgbestemmelser_konv_efta_storbritannia.KONV_EFTA_STORBRITANNIA_ART13_3C, Bestemmelse.ART_11_3_c)
            .put(Lovvalgbestemmelser_konv_efta_storbritannia.KONV_EFTA_STORBRITANNIA_ART13_3D, Bestemmelse.ART_11_3_d)
