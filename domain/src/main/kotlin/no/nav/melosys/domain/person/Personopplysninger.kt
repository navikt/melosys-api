...
data class Personopplysninger(
    ...
    override fun hentKjønnType(): KjoennType = kjønn ?: error("Kjønn er påkrevd for ${this::class.simpleName}")
    ...
    override fun finnKontaktadresse(): Optional<Kontaktadresse> =
        kontaktadresser
            .maxByOrNull { it.hentRegistrertDato() }
    ...
    private fun lagPostadresseFraBostedsadresse(): Optional<Postadresse> =
        finnBostedsadresse().flatMap { bostedsadresse ->
            Optional.ofNullable(
