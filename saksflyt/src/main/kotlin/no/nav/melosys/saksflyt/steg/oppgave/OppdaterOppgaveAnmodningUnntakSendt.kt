...
class OppdaterOppgaveAnmodningUnntakSendt(private val oppgaveService: OppgaveService) : StegBehandler {
    ...
    override fun inngangsSteg(): ProsessSteg = ProsessSteg.OPPDATER_OPPGAVE_ANMODNING_UNNTAK_SENDT
    ...
    override fun utfør(prosessinstans: Prosessinstans) {
        ...
        log.info(
            "Oppdatert oppgave ${oppgave.oppgaveId} med beskrivelse, og frist som samsvarer med behandlingsfristen"
        )
    }
