...
object ProsessflytDefinisjon {
    private val PROSESS_FLYT_MAP: Map<ProsessType, ProsessFlyt> = mapOf(
        ...
        MOTTAK_SOKNAD_UTSENDT_ARBEIDSTAKER to ProsessFlyt(
            prosessType = MOTTAK_SOKNAD_UTSENDT_ARBEIDSTAKER,
            HENT_SOKNADSDATA_UTSENDT_ARBEIDSTAKER,
            OPPRETT_SAK_OG_BEHANDLING_UTSENDT_ARBEIDSTAKER,
            OPPRETT_OG_FERDIGSTILL_JOURNALPOST_UTSENDT_ARBEIDSTAKER,
            LAGRE_SAKSOPPLYSNINGER_UTSENDT_ARBEIDSTAKER,
            HENT_REGISTEROPPLYSNINGER,
            OPPRETT_OPPGAVE
        ),
