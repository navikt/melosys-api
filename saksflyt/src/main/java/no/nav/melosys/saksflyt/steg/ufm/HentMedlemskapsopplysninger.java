...
public class HentMedlemskapsopplysninger extends AbstraktStegBehandler {
    ...
    @Autowired
    HentMedlemskapsopplysninger(HentOpplysningerFelles hentOpplysningerFelles, SaksopplysningerService saksopplysningerService) {
    ...
    protected void utfør(Prosessinstans prosessinstans) throws TekniskException, FunksjonellException {
        ...
        if (!PeriodeKontroller.feilIPeriode(fom, tom)) {
            ...
            log.info("Kunne ikke hente medlemskapopplysninger grunnet feil i periode");
        }
