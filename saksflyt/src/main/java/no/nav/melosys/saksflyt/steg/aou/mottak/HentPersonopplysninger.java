...
@Component("AnmodningUnntakMottakHentPersonopplysninger")
public class HentPersonopplysninger extends AbstraktStegBehandler {
    ...
    protected ProsessSteg inngangsSteg() {
        return ProsessSteg.AOU_MOTTAK_HENT_PERSON;
    }
    ...
    protected void utfør(Prosessinstans prosessinstans) throws TekniskException, FunksjonellException {
        ...
        prosessinstans.setSteg(ProsessSteg.AOU_MOTTAK_HENT_MEDLEMSKAP);
    }
}
