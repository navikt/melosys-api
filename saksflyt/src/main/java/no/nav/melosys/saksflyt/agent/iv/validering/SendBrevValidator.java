...
public enum SendBrevValidator {
     ...
     */
    public static boolean avslagsbrevSkalSendes(BehandlingsresultatType behandlingsresultatType, Lovvalgsperiode lovvalgsperiode) {
     ...
     * <li>Lovvalgbestemmelsen er 12.1, 12.2 eller 16.1</li>
     */
    public static boolean innvilgelsesbrevSkalSendes(BehandlingsresultatType behandlingsresultatType, Lovvalgsperiode lovvalgsperiode) {
        return behandlingsresultatType == BehandlingsresultatType.FASTSATT_LOVVALGSLAND
