 ...
 */
@Component
public class FerdigStillOppgave extends AbstraktStegBehandler {

    private static final Logger log = LoggerFactory.getLogger(FerdigStillOppgave.class);

    private final GsakFasade gsakFasade;

    @Autowired
    public FerdigStillOppgave(@Qualifier("system")GsakFasade gsakFasade) {
    ...
    public void utfør(Prosessinstans prosessinstans) throws TekniskException, FunksjonellException {
        ...
        if (type == ProsessType.IVERKSETT_VEDTAK) {
