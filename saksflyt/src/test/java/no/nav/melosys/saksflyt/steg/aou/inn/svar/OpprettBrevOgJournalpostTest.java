...
public class OpprettBrevOgJournalpostTest {
    ...
    public void setup() throws MelosysException {
        when(sedSomBrevService.lagJournalpostForSendingAvSedSomBrev(any(SedType.class), any(Landkoder.class), any()))
            .thenReturn("1234");
        when(eessiService.hentSedTypeForAnmodningUnntakSvar(anyLong())).thenReturn(SedType.A002);

        opprettBrevOgJournalpost = new OpprettBrevOgJournalpost(eessiService, sedSomBrevService);
    }
    ...
    public void utfør() throws MelosysException {
        ...
        verify(sedSomBrevService).lagJournalpostForSendingAvSedSomBrev(any(SedType.class), any(Landkoder.class), any());
