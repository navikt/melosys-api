...
public class IverksettVedtakSendBrevTest {
    ...
    private static IverksettVedtakSendBrev lagStegbehandler(Behandling behandling) throws Exception {
        ...
        BrevBestiller brevBestiller = new BrevBestiller(dokService, byggerVelger, mock(DokumentdataInput.class));
    ...
    private static DokumentSystemService lagDokumentService(BrevDataByggerVelger brevDataByggerVelger) throws TekniskException {
        ...
        return spy(new DokumentSystemService(behandlingRepository, brevDataService, dokSysFasade, brevmottakerService, brevDataByggerVelger, mock(DokumentdataInput.class)));
    }
