...
class OppdaterFakturamottakerTest {
    ...
    fun utfør_ingenBehandlingerMedFakturaserieReferanser_kallerIkkeFaktureringskomponenten() {
        every { fagsakService.hentFagsak(SAKSNUMMER) } returns FagsakTestFactory.builder().apply {
            leggTilBehandling(Behandling.buildWithDefaults { id = BEHANDLING_ID })
        }.build()
    ...
    fun utfør_flereBetalingerMedReferanse_kallerFaktureringskomponentMedNyligsteReferanse() {
        ...
        val fagsak = FagsakTestFactory.builder().apply {
            ...
            leggTilBehandling(Behandling.buildWithDefaults {
                id = BEHANDLING_ID
    ...
    fun utfør_referanseMenIngenFullmektig_kallerFaktureringskomponentMedTomFullmektig() {
        val fagsak = FagsakTestFactory.builder().behandlinger(Behandling.buildWithDefaults { id = BEHANDLING_ID }).build()
