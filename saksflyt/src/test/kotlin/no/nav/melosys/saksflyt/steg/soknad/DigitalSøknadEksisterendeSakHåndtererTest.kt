...
internal class DigitalSøknadEksisterendeSakHåndtererTest {
    ...
    private lateinit var håndterer: DigitalSøknadEksisterendeSakHåndterer
    ...
    @BeforeEach
    fun setup() {
        håndterer = DigitalSøknadEksisterendeSakHåndterer(
    ...
    inner class ÅpenBehandlingUnderBehandling {
        ...
        fun `setter status til VURDER_DOKUMENT og kaller toemBehandlingsresultat`() {
            ...
            val resultat = håndterer.håndter(saksnummer, søknadsdata)
    ...
    inner class ÅpenBehandlingOpprettet {
        ...
        fun `oppdaterer behandlingstema for åpen behandling når tema utledes annerledes`() {
            ...
            val fagsak = lagFagsakMedBehandling(behandling)
            val offentligSøknadsdata = lagOffentligSøknadsdata()
    ...
    inner class IkkeSøknadsbehandlingstype {
        ...
        fun `aktiv behandling med annen type faller gjennom til opprettNyVurdering`() {
            ...
            resultat shouldBe nyBehandling
        }
    }
    ...
    private fun lagBehandling(
        ...
        return Behandling.forTest {
            id = this@DigitalSøknadEksisterendeSakHåndtererTest.behandlingId
            this.status = status
            type = behandlingstype
            tema = behandlingstema
            this.fagsak = Fagsak.forTest { this.saksnummer = this@DigitalSøknadEksisterendeSakHåndtererTest.saksnummer }
        }
    }
    ...
    private fun lagOffentligSøknadsdata(): UtsendtArbeidstakerSkjemaM2MDto =
