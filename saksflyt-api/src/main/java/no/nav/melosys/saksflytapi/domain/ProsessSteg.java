...
public enum ProsessSteg {
    ...
    HENT_SOKNAD_FRA_SKJEMA_API("HENT_SOKNAD_FRA_SKJEMA_API", "Henter søknadsdata fra skjema-api"),
    ...
    LAGRE_SAKSOPPLYSNINGER_SKJEMA("LAGRE_SAKSOPPLYSNINGER_SKJEMA", "Lagrer søknadsdata fra skjema for visning i sidemeny"),
    ...
    OPPRETT_SAK_OG_BEHANDLING_SKJEMA("OPPRETT_SAK_OG_BEHANDLING_SKJEMA", "Oppretter fagsak og behandling fra mottatt skjema-søknad"),
