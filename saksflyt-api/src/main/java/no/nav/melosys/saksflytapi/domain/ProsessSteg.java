...
public enum ProsessSteg {
    ...
    HENT_OG_LAGRE_UTSENDT_ARBEIDSTAKER_SKJEMADATA("HENT_OG_LAGRE_UTSENDT_ARBEIDSTAKER_SKJEMADATA", "Henter og lagrer søknadsdata for utsendt arbeidstaker fra skjema-api"),
