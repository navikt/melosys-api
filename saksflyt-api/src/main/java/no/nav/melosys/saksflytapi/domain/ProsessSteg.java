...
public enum ProsessSteg {
    ...
    HENT_SOKNADSDATA_UTSENDT_ARBEIDSTAKER("HENT_SOKNADSDATA_UTSENDT_ARBEIDSTAKER", "Henter søknadsdata og PDF for utsendt arbeidstaker fra skjema-api"),
    ...
    KNYTT_JOURNALPOST_TIL_SAK("KNYTT_JOURNALPOST_TIL_SAK", "Knytter journalpost til saken i Joark"),
    ...
    LAGRE_SAKSOPPLYSNINGER_UTSENDT_ARBEIDSTAKER("LAGRE_SAKSOPPLYSNINGER_UTSENDT_ARBEIDSTAKER", "Lagrer søknadsdata fra utsendt arbeidstaker-søknad for visning i sidemeny"),
    ...
    OPPRETT_OG_FERDIGSTILL_JOURNALPOST_UTSENDT_ARBEIDSTAKER("OPPRETT_OG_FERDIGSTILL_JOURNALPOST_UTSENDT_ARBEIDSTAKER", "Oppretter og ferdigstiller journalpost med sakstilknytning for utsendt arbeidstaker"),
    ...
    OPPRETT_SAK_OG_BEHANDLING_UTSENDT_ARBEIDSTAKER("OPPRETT_SAK_OG_BEHANDLING_UTSENDT_ARBEIDSTAKER", "Oppretter fagsak og behandling fra mottatt utsendt arbeidstaker-søknad"),
