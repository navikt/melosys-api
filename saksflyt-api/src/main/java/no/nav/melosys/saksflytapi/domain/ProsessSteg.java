...
public enum ProsessSteg {
    ...
    OPPRETT_OG_FERDIGSTILL_JOURNALPOST_SØKNAD("OPPRETT_OG_FERDIGSTILL_JOURNALPOST_SØKNAD", "Oppretter og ferdigstiller journalpost med sakstilknytning for søknad"),
    ...
    OPPRETT_SAK_OG_BEHANDLING_SØKNAD("OPPRETT_SAK_OG_BEHANDLING_SØKNAD", "Oppretter fagsak og behandling fra mottatt søknad"),
