...
public enum ProsessSteg {
    ...
    HENT_DIGITAL_SØKNADSDATA("HENT_DIGITAL_SØKNADSDATA", "Henter søknadsdata"),
    HÅNDTER_EKSISTERENDE_SAK_DIGITAL_SØKNAD("HÅNDTER_EKSISTERENDE_SAK_DIGITAL_SØKNAD", "Håndterer eksisterende sak for mottatt søknad"),
    SEND_SAKSNUMMER_TIL_MELOSYS_SKJEMA_API("SEND_SAKSNUMMER_TIL_MELOSYS_SKJEMA_API", "Sender saksnummer tilbake til melosys-skjema-api"),
    ...
    OPPRETT_OG_FERDIGSTILL_JOURNALPOST_DIGITAL_SØKNAD("OPPRETT_OG_FERDIGSTILL_JOURNALPOST_DIGITAL_SØKNAD", "Oppretter og ferdigstiller journalpost med sakstilknytning for søknad"),
    ...
    OPPRETT_SAK_OG_BEHANDLING_DIGITAL_SØKNAD("OPPRETT_SAK_OG_BEHANDLING_DIGITAL_SØKNAD", "Oppretter fagsak og behandling fra mottatt søknad"),
    ...
    AVSLUTT_AARSAVREGNINGER("AVSLUTT_AARSAVREGNINGER", "Avslutter åpne årsavregninger på annullert behandling"),
    SEND_INNHENTINGSBREV_AARSAVREGNING("SEND_INNHENTINGSBREV_AARSAVREGNING", "Sender innhentingsbrev ved automatisk opprettet årsavregning");
