...
**Status**: ✅ Completed
**Verdict**: Changed
**Comments**: Converted all 5 test names from underscore style to backtick style with Norwegian descriptions.
...
- [N/A] Companion objects are placed at the bottom of the class (no companion object)
