...
public class ArbeidsavtaleDtoTest {
    ...
    public void tilDto() throws Exception {
        ...
        List<Arbeidsforhold> arbeidsforhold = response.getParameters().getArbeidsforhold();

        for (Arbeidsforhold a : arbeidsforhold) {
            List<Arbeidsavtale> avtaler = a.getArbeidsavtale();
            for (Arbeidsavtale avtale : avtaler) {
                ArbeidsavtaleDto dto = ArbeidsavtaleDto.tilDto(avtale);
                ...
                if (avtale instanceof MaritimArbeidsavtale) {
                    assertEquals(dto.getFartsområde(), ((MaritimArbeidsavtale) avtale).getFartsomraade().getValue());
                    assertEquals(dto.getSkipsregister(), ((MaritimArbeidsavtale) avtale).getSkipsregister().toString());
                    assertEquals(dto.getSkipstype(), ((MaritimArbeidsavtale) avtale).getSkipstype().toString());
                }
