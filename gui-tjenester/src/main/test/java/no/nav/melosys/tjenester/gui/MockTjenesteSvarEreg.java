...
public class MockTjenesteSvarEreg {

    public static Organisasjon SVAR;

    MockTjenesteSvarEreg () throws JAXBException {
        ...
        SVAR = response.getResponse().getOrganisasjon();
    }

    String xml = "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?><ns2:hentOrganisasjonResponse xmlns:ns2=\"http://nav.no/tjeneste/virksomhet/organisasjon/v4\">" +
