...
public class GateadresseDtoTest {
    ...
    public void tilDto() throws Exception {
        ...
        if (adresse instanceof Gateadresse) {
            ...
            GateadresseDto gateadresse = personDto.getBostedsadresse().getGateadresse();
            assertEquals(gateadresse.getGatenavn(), ((Gateadresse) adresse).getGatenavn());
            assertEquals(gateadresse.getGatenummer(), ((Gateadresse) adresse).getGatenummer());
            assertEquals(gateadresse.getHusbokstav(), ((Gateadresse) adresse).getHusbokstav());
            assertEquals(gateadresse.getHusnummer(), ((Gateadresse) adresse).getHusnummer());
