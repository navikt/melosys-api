...
public class PersonDtoTest {
    ...
    public void tilDto() throws Exception {
        ...
        assertEquals(personDto.getFnr(), ((PersonIdent)(person.getAktoer())).getIdent().getIdent());
        assertEquals(personDto.getSivilstand(), person.getSivilstand().getSivilstand().getValue());
        assertEquals(personDto.getStatsborgerskap(), person.getStatsborgerskap().getLand().getValue());
        assertEquals(personDto.getKjoenn(), person.getKjoenn().getKjoenn().getValue());
        assertEquals(personDto.getFornavn(), person.getPersonnavn().getFornavn());
        assertEquals(personDto.getEtternavn(), person.getPersonnavn().getEtternavn());
        assertEquals(personDto.getSammensattNavn(), person.getPersonnavn().getSammensattNavn());
        assertEquals(personDto.getFoedselsdato(), person.getFoedselsdato().getFoedselsdato().toGregorianCalendar().toZonedDateTime().toLocalDate());

        //personDto.getBostedsadresse() testes i BostedsadresseDto
