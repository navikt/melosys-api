...
object MetrikkerNavn {
    ...
    const val PROSESSINSTANSER_TID_BRUKT = "$PROSESSINSTANSER.tid.brukt"
    ...
    const val PROSESSINSTANSER_BEHANDLET = "$PROSESSINSTANSER.behandlet"
    ...
    const val TAG_PRIORITET = "prioritet"
}
